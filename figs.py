...
async def _rebuild_movies(client: FigsClient, db: aiosqlite.Connection):
    ...
    print("[Figs SQLite] Baixando catálogo completo de filmes...")
    try:
        ...
        await db.commit()
        print(f"[Figs SQLite] {inserted_count} filmes salvos no SQLite.")
    except Exception as e:
...
async def _rebuild_series(client: FigsClient, db: aiosqlite.Connection):
    ...
    print("[Figs SQLite] Baixando catálogo completo de séries...")
    try:
        ...
        await db.commit()
        print(f"[Figs SQLite] {inserted_count} séries salvas no SQLite.")
    except Exception as e:
